...
<html>
<head>
	<title>Sistem Informasi Pemesanan Kamar Hotel Batam</title>
...
<body>
	<nav>
			<img src="../gambar/logobaru.png" width="50px"> <span style="float: right; margin-right: 80px;"><center><img src="../simpangambar/<?php 
				if ($foto != '') {
					echo $foto;
				}
				else {
