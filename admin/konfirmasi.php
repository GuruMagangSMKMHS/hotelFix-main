	...
	<aside>
		<center>
			...
			<div id="kanan">
				...
				<?php
					$sql = $pdo->query("select * from pembayaran  right join pemesanan on  pembayaran.idpesan = pemesanan.idpesan; ORDER BY idpesan DESC"); 
					// $sql = $pdo->query("SELECT * FROM pemesanan ORDER BY idpesan DESC"); 
					// $sql1 = $pdo->query("SELECT * FROM pembayaran");
				...
				<tr align="center" style="font-weight: normal; font-size: 12px;">
					...
					<td class="tkonfirm">
						<a href="../simpangambar/<?php echo $gambar ?>" target="_blank"><img src="../simpangambar/<?php echo $gambar ?>" width="100px" height="50px"/></a>
